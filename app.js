...
function displaySearchArtists(artistslist) {
  ...
  if (artistslist) {
    ...
    document
      .querySelector("#artist_search_table tbody")
      .innerHTML("No artists found :(");
  }
}
...
function displaySearchTrack(trackslist) {
  ...
  if (trackslist) {
    ...
    document
      .querySelector("#track_search_table tbody")
      .innerHTML("No tracks found");
  }
}
...
function displaySearchAlbum(listOfAlbums) {
  ...
  if (listOfAlbums) {
    ...
    document
      .querySelector("#album_search_table tbody")
      .innerHTML("No albums found");
  }
}
